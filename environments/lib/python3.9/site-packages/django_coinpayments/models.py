...
class Payment(TimeStampedModel):
    ...
    currency_original = models.CharField(max_length=12, choices=get_coins_list(), verbose_name=_('Original currency'))
    currency_paid = models.CharField(max_length=12, choices=get_coins_list(), verbose_name=_('Payment currency'))
    amount = models.DecimalField(max_digits=65, decimal_places=18, verbose_name=_('Amount'))
    ...
    def __str__(self):
        return "{} of {} - {}".format(str(self.amount_paid), str(self.amount), self.get_status_display())
